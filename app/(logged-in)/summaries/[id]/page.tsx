...
export default async function SummaryPage(props: {
  ...
  return (
    <div className=" relative isolate min-h-screen bg-linear-to-b from-rose-50/40 to to-white">
      <BgGradient />
            ...
            >
              <div
                className=" absolute inset-0
                 bg-linear-to-br from-rose-50/50 via-orange-50/30 to-transparent opacity-50
